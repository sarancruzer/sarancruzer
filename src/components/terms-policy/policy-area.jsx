          ...
          <div className="col-xl-10">
            <div className="policy__wrapper policy__translate p-relative z-index-1">
              <div className="policy__item mb-35">
                ...
                <p>
                  sarancruzer knows that you care about how your personal information
                  is used and shared, and sarancruzer takes your privacy seriously.
                  Please read the following to learn more about sarancruzer Privacy
                ...
                <p>
                  ...
                  sarancruzer will collect, use, and share your information in the
                  following ways. Remember that your use of Services is at all
                  times subject to the Terms as set forth at
                  https://sarancruzer.com/legal/terms, which incorporate this Privacy
                  Policy. Any terms sarancruzer uses in this Privacy Policy without
              ...
              <div className="policy__contact">
                ...
                <ul>
                  <li>
                    Email:{" "}
                    <span>
                      <a href="mailto:sarancruzer.com">support@sarancruzer.com</a>
                    </span>
                  </li>
                </ul>
                ...
                <div className="policy__address">
                  <p>
                    <a
                      ...
                      target="_blank"
                    >
                      sarancruzer PTY LTD <br /> 4270, Brisbane, Australia
                    </a>
                  </p>
                </div>
              </div>
